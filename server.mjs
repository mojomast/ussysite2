...
const htmlSecurityHeaders = {
  ...
  'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' https://ussyco.de https://unpkg.com https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://ussyco.de https://openrouter.ai https://unpkg.com https://cdnjs.cloudflare.com; img-src 'self' data: blob:; worker-src blob:; frame-ancestors 'none'"
};
